...
ServerBootstrapper 中的初始化关键代码： private GraphDatabaseDependencies dependencies = GraphDatabaseDependencies.newDependencies(); 这个dependencies貌似来头很大。F5进入 public static GraphDatabaseDependencies newDependencies()
```
